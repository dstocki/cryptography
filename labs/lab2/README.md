...
Additionaly, implement exponentiation - repeated multiplication - using an efficient algorithm, that is, exponentiation $a^{exp}$ should have complexity $O(log(exp))$ of multiplications.
